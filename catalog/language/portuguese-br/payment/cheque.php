<?php
// Text
$_['text_title']       = '<img src="image/pagamento/cheque.jpg" alt="Instruções para pedido em dinheiro/cheque" title="Instruções para pedido em dinheiro/cheque" style="border 1px solid #EEEEEE;" /></a>';
